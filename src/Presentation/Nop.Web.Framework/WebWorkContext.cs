...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public virtual Task SetCookieRequestCultureAsync(string languageCulture)
        {
        ...
        public virtual async Task SetWorkingLanguageAsync(Language language)
        {
            ...
            if(!string.IsNullOrEmpty(language?.LanguageCulture))
            {
                response.Cookies.Append(
                    ...
                    CookieRequestCultureProvider.MakeCookieValue(new RequestCulture(language.LanguageCulture, language.LanguageCulture)),
