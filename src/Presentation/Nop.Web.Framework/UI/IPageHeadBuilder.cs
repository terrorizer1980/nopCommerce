namespace Nop.Web.Framework.UI
{
    ...
    public partial interface IPageHeadBuilder
    {
        ...
        void AddScriptParts(ResourceLocation location, string src, string debugSrc, bool excludeFromBundle, bool isAsync, string version = null);
        ...
        /// <param name="isAsync">A value indicating whether to add an attribute "async" or not for js files</param>
        /// <param name="version">The file version</param>
        void AppendScriptParts(ResourceLocation location, string src, string debugSrc, bool excludeFromBundle, bool isAsync, string version = null);
        ...
        /// <param name="excludeFromBundle">A value indicating whether to exclude this script from bundling</param>
        /// <param name="version">The file version</param>
        void AddCssFileParts(ResourceLocation location, string src, string debugSrc, bool excludeFromBundle = false, string version = null);
        ...
        /// <param name="excludeFromBundle">A value indicating whether to exclude this script from bundling</param>
        /// <param name="version">The file version</param>
        void AppendCssFileParts(ResourceLocation location, string src, string debugSrc, bool excludeFromBundle = false, string version = null);
